...
def normalize_all(raw_results):
    ...
    normalized_list = [
        {
            "path": "app/utils.py", "line": 42, "tool": ["Bandit"],
            "rule_id": "CWE-78", "severity": "HIGH", "confidence": 0.8,
            "message": "Command injection via subprocess shell=True"
        },
        {
            "path": "app/utils.py", "line": 42, "tool": ["Semgrep"],
            "rule_id": "CWE-78", "severity": "HIGH", "confidence": 0.9,
            "message": "Command injection via subprocess shell=True"
        }
    ]
